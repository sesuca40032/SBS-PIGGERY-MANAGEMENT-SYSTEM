...
$query = $db->query("SELECT SUM(total_pigs) AS total FROM pig_batches");
$result = $query->fetch(PDO::FETCH_ASSOC);
$totalPigs = $result['total'];
...
<div class="dashboard-counters">
    <div class="counter-card pig-counter">
        ...
        <div class="counter-content">
            <div class="counter-value"><?php echo number_format($totalPigs); ?></div>
    ...
    <div class="counter-card user-counter">
        ...
        <div class="counter-footer">
            <a href="add-users.php">View All <i class="fas fa-arrow-right"></i></a>
        </div>
    </div>
</div>
